...
public class MyUserDetailsService implements UserDetailsService {
    ...
    @Autowired
    private TaskManagerServiceImpl userService;
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        List<GrantedAuthority> authorities = getUserAuthority(newuser.getRoles());
        return buildUserForAuthentication(newuser, authorities);
    }
